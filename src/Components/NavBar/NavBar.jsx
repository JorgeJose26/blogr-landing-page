...
function NavBar(props) {
    ...
    return (
        <header className='body rounded-bl-[5rem]'>
            <nav className='pt-2'>
                <div className='flex flex-row justify-between items-center pl-6 pr-6 pt-[3.5rem] pb-14 dt:pb-[6.5rem] dt:justify-start
                dt:gap-[3rem] dt:pl-[5rem] dt:items-center dt:pl-[11rem]'>
                    ...
                    <div className='hidden dt:flex dt:flex-row dt:gap-[2rem] dt:items-center dt:pl-[25rem]'>
                        ...
                        pr-[2rem] font-bold hover:bg-[#FF7A85] hover:text-white'>Sign Up</buttom>
                    </div>
            ...
            <hero className='space-y-4'>
                ...
                <div className='flex flex-row justify-center gap-3 pb-36 pt-5'>
                    <button className='text-[#FF525D] font-bold rounded-full bg-white h-10 w-24  text-xs dt:h-12 dt:w-32 dt:text-sm hover:bg-[#FF7A85]
                    hover:text-white'>Start for Free</button>
                    <button className='text-white outline outline-white-500 rounded-full h-10 w-24 text-xs dt:h-12 dt:w-32 dt:text-sm hover:text-[#FF525D]
                     hover:bg-white'>Learn More</button>
                </div>
            </hero>
