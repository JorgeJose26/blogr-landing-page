    ...
    return (
        <body>
            ...
            <section className='flex flex-col flex-wrap pt-12 justify-around pl-6 pr-6'>
                ...
                <p className='text-[16px] text-[#4B5862] '>Blogr feature an exceedingly intutive interface which lets you focus on one thing: creating content.
            ...
            <section className='flex flex-col flex-wrap pt-12 justify-around pl-6 pr-6'>
                ...
                <p className='text-[16px] text-[#4B5862]'>Flexible content mangement enables users to easly move through posts. increase the usablity of your blog by adding
            ...
            <section className='infrastructure flex flex-col flex-wrap pt-12 justify-around pt-[12rem] pl-6 pr-6 rounded-tr-[5rem]
                rounded-bl-[5rem] mt-[20rem] pb-[15rem] static items-center'>
                <img className='absolute top-[105rem] left-[0rem] w-[505] ' src={phones} alt='phones' />
                <h2 className='text-[#1F3F5B] text-[2.5rem] pb-6  text-white'>State of the Art Infrastructure</h2>
                <p className='text-[#C8C8CB] text-[16px]'>With reliability and speed in mind, worldwide data centers provide the backbone for ultra
