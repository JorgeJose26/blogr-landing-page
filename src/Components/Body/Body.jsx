    ...
    return (
        <body>
            ...
            <section className='infrastructure flex flex-col flex-wrap pt-12 justify-around pt-[12rem] pl-6 pr-6 rounded-tr-[5rem]
                ...
                <img className='absolute top-[105rem] left-[0rem] w-[505] dt:top-[81rem] dt:left-[9rem] ' src={phones} alt='phones' />
            ...
            <section className='flex flex-col flex-wrap pt-12 justify-around pl-6 pr-6 mb-[6rem] dt:pl-[52rem] dt:pr-[8rem] dt:mb-[8rem]'>
                ...
                <p className='text-[#4B5862] text-lg  dt:text-left dt:text-[16px]'>Batteries included. We built a simple and strightfoward CLI tool that makes
